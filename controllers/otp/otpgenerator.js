...
module.exports.otp=async function(req,res){
    try{
        ...
        let otpgenerate1=await otpgenerator.generate(6, { upperCase: false, specialChars: false,alphabets:false,digits:true });
        ...
        let sendSMTPEmail = {
            ...
            body: {
                ...
                htmlContent:
                `your otp is ${otpgenerate1}. Otp valid for only 1 min`
            },
        json: true,
        };
